...
//                     <div
//                         key={index}
//                         className="p-5 rounded-xl border border-gray-200 shadow-sm hover:shadow-md transition"
//                     >
//                         {/* Question */}
...
//                                     <li
//                                         key={i}
//                                         className={`px-3 py-2 rounded-lg border ${isCorrect
...
/**
 * QuizAnalysisWithScoring
 * - Reads localStorage.getItem("quizQuestions")
 * - Score rule: +4 for correct, -1 for wrong, 0 for unattempted
 * - Highlights correct answers (green) and user's wrong choices (red)
 */
function Result() {
    const [questions, setQuestions] = useState([]);
